...
<body style='background-image:url(/img/car.jpg); background-size:100% ; color:white'>
  ...
  <br><br>
  <h1 class="display-2 text-center">Müşteri Filtreleme Sayfası</h1><br><hr><br>
  <div class="row">
    <div class="col">
...
if(isset($_POST['musteriNo'])){
    ...
    $result=$pdo->prepare('SELECT "musteriNo","ad","soyad","cinsiyetNo","ilNo" from "Musteri" WHERE "musteriNo"=?');
    $result->bindParam(1, $musteriNo, PDO::PARAM_STR);
